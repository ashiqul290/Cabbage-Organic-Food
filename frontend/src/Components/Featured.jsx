...
const Featured = () => {
  return (
    <>
      ...
      />
      <Container>
        <div className="grid grid-cols-4 gap-5 justify-between mt-7">
          <div className="w-67.5 h-92.5 group-hover: group  duration-500 p-2 shadow-[0_0_5px] shadow-gray-950/15 rounded-[10px] ">
            <div className=" relative w-full h-57.5 bg-tertiary rounded-[10px]">
              <div className=" group-hover:flex duration-500 ease-in-out hidden gap-1  rounded-[10px] justify-center items-center w-full h-full group-hover:bg-tertiary/40">
                <div className=" cursor-pointer bg-white  w-[35px] h-[35px] rounded-full rounded-full flex justify-center items-center text-secondary hover:bg-secondary hover:text-white duration-500 ">
                ...
                <div className=" cursor-pointer bg-white p-2 w-[35px] h-[35px] rounded-full rounded-full flex justify-center items-center text-secondary hover:bg-secondary hover:text-white duration-500">
